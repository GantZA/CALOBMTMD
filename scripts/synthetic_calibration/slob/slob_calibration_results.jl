...
# [1.738, 1.752, 0.669, 1.512, 124.843]
...
quantile(abc_reject_we.distances, collect(0:0.1:1.0))
new_cutoff = 22.0
sum(abc_reject_we.distances .<= new_cutoff)
...
# [1.806, 1.749, 0.525, 1.466, 120.572]
...
# [1.819, 1.748, 0.517, 1.402, 114.808]
